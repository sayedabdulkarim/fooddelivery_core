                ...
                <div className="DeliveryAddressView_wrapper_1zazTnRd">
                  <div className="DeliveryAddressView_innerWrapper_3H4RKzRr">
                    ...
                    <p className="ScreenReaderOnly_screenReaderOnly_15MQ-BaD">
                      Delivering to: Other Looks Studio, Looks Studio ,, # 10/5,
                      1st Main, Koramangala, Khb Colony, 5th Block, Koramangala,
                        ...
                        <div className="PaymentOption-v4_container_2NfWVPjQ">
                          ...
                          >
                            ...
                            <div
                              ...
                              aria-hidden="true"
                            >
                              Pluxee/Sodexo card valid only on Food &amp;
                              Instamart
                            </div>
                          </div>
                          <div
